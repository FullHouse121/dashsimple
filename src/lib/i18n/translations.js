...
export const translations = {
  tr: {
    ...
    "Rev/uniq": "Gelir/tekil",
    "countries": "ülke",
    "Share of the ranked metric": "Sıralanan metriğin payı",
    "unique": "tekil",
    ...
    Targets: "Hedefler",
    "Set a target": "Hedef belirle",
    Currently: "Şu anda",
    currently: "şu anda",
    "at close": "kapanışta",
    "not valued": "değerlenmedi",
    "day needed": "gün gerekli",
    needed: "gerekli",
    Pace: "Tempo",
    Scope: "Kapsam",
    "Team target": "Takım hedefi",
    "Individual targets": "Bireysel hedefler",
    "Your targets": "Hedefleriniz",
    "Shared across every buyer": "Tüm alıcılar için ortak",
    "Shared target, measured on your own numbers": "Ortak hedef, kendi rakamlarınızla ölçülür",
    "No individual goals set yet.": "Henüz bireysel hedef belirlenmedi.",
    each: "her biri",
